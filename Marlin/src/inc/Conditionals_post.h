 ...
 */
  ...
  #if ANY(HAS_MARLINUI_MENU, EXTENSIBLE_UI, DWIN_LCD_PROUI, DWIN_CREALITY_LCD_JYERSUI, DWIN_CREALITY_LCD_ENHANCED, RTS_AVAILABLE) || BOTH(EMERGENCY_PARSER, HOST_PROMPT_SUPPORT)
...
#if ANY(HAS_MARLINUI_MENU, TOUCH_UI_FTDI_EVE, HAS_LCD_MENU)
